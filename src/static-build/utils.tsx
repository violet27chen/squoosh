...
export const siteOrigin = (() => {
  ...
  if (process.env.CONTEXT === 'production') return 'https://image.violet27chen.com';
  if (process.env.DEPLOY_PRIME_URL) return process.env.DEPLOY_PRIME_URL;
  console.warn(
    'Unable to determine site origin, defaulting to https://image.violet27chen.com',
  );
  return 'https://image.violet27chen.com';
})();
