...
> **Cloudflare variant**: identical API (same `/image/<opts>/<path>` and `?url=`), different engine (Cloudflare native image resizing). See [README.cloudflare.md](./README.cloudflare.md).
